...
Чуть позже, если захотим единый кастомный формат всех ProblemDetails, тогда специально напишем свой IProblemDetailsWriter — и ты увидишь эту цепочку уже на собственном коде.
